...
- [Дескрипторы (просто теория)](https://habr.com/ru/post/122082/)
- [Дескрипторы (примеры вызовов)](https://habr.com/ru/post/479824/)
- [Динамические атрибуты](https://amir.rachum.com/blog/2016/10/05/python-dynamic-attributes/)
...
- [Двоичное дерево поиска (Binary search tree)](https://ru.wikipedia.org/wiki/Двоичное_дерево_поиска)
